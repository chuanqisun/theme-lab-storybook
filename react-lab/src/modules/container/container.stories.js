...
import { containerData, containerDataClamped, knobify } from './container.data';
...
export const basic = () => <Container {...knobify(containerData)}>{sampleText}</Container>;
export const clamped = () => <Container {...knobify(containerDataClamped)}>{sampleText}</Container>;
